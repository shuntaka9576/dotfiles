...
build: clean
	...
	jq 'del(.mcpServers) + $$mcp[0]' ~/.claude.json --slurpfile mcp ~/dotfiles/home-manager/programs/mcp/.mcp-claude-code.json > ~/.claude.json.tmp && mv ~/.claude.json.tmp ~/.claude.json
